...
public class Week2CodingAssignment {
    ...
    public static void main(String[] args) {
    	...
    	// Declare a variable of type String to capture user input
        String userInputStringOfAngles;  
        
        // Declare a variable of type int to hold the converted user input
        int numberOfAngles; 
        ...
        // Capture user input as string
        userInputStringOfAngles= myInputScannerInstance.next(); 
        
        // Convert the string to a number in case this will be useful later
        numberOfAngles = Integer.parseInt(userInputStringOfAngles); 
        
        // Validate user Input
        if (numberOfAngles < 3 || numberOfAngles > 5)
        {
        	System.out.print("You have entered an invalid integer.");
        	return;
        }
            
        // Print the correct shape based on numberOfAngles
